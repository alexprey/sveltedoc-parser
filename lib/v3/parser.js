...
class Parser extends EventEmitter {
    ...
    constructor(options) {
        ...
        this.scriptParserFactory = options.scriptParserFactory;
    ...
    buildScriptParser() {
        ...
        this.scriptParser = typeof this.scriptParserFactory === 'function'
            ? this.scriptParserFactory(scriptParserOptions)
            : new ScriptParser(scriptParserOptions);
