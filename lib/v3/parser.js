    ...
    parseBodyRecursively(rootNode, parseContext, level) {
        ...
        nodes.forEach((node, index) => {
            if (index === 0) {
                ...
                if (utils.isTopLevelComment(firstComment)) {
                    this.emit('description', firstComment.description);
                    this.emit('keywords', firstComment.keywords);
                }
            }
                ...
                if (tagName === 'slot') {
                    ...
                    if (this.features.includes('events')) {
                        ...
                        baseEvents.forEach((event) => {
                            ...
                            if (!this.eventsEmitted.hasOwnProperty(event.name)) {
