...
class Parser extends EventEmitter {
    ...
    emitDataItem(variable, isStaticScope, defaultVisibility, parentComment) {
    ...
    emitMethodItem(method, isStaticScope, defaultVisibility, parentComment) {
    ...
    parseBodyRecursively(rootNode, isStaticScope, level) {
        rootNode.body.forEach(node => {
                ...
                variables.forEach(variable => {
                    ...
                    if (variable.declarator.init) {
                        ...
                        if (initNode.type === 'CallExpression') {
                            ...
                            if (initNode.body) {
                                this.parseBodyRecursively(initNode.body, isStaticScope, level + 1);
                            }
                        }
                    }
                });
            ...
            if (node.type === 'FunctionDeclaration') {
                ...
                if (node.body) {
                    this.parseBodyRecursively(node.body, isStaticScope, level + 1);
                }
                return;
            }

            if (node.type === 'ExportNamedDeclaration' && level === 0) {
                ...
                if (declaration) {
                    ...
                    if (declaration.type === 'VariableDeclaration') {
                        ...
                        variables.forEach(variable => {
                            this.emitDataItem(variable, isStaticScope, 'public', exportNodeComment);
                        });
                    ...
                    if (declaration.type === 'FunctionDeclaration') {
                        ...
                        this.emitMethodItem(func, isStaticScope, 'public', exportNodeComment);
            ...
            if (node.type === 'LabeledStatement' && level === 0) {
            ...
            if (node.type === 'ImportDeclaration' && level === 0) {
    ...
    parseScriptBlock(scriptBlock) {
        ...
        this.parseBodyRecursively(ast, isStaticScope, 0);
    }
